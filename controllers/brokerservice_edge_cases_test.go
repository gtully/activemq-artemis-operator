				...
				apps[i] = &brokerv1beta1.BrokerApp{
					...
					Spec: brokerv1beta1.BrokerAppSpec{
						...
						Capabilities: []brokerv1beta1.AppCapabilityType{
							{
								Role:       "workQueue",
								ProducerOf: []brokerv1beta1.AppAddressType{{Address: fmt.Sprintf("RAPID.Q%d", i)}},
								ConsumerOf: []brokerv1beta1.AppAddressType{{Address: fmt.Sprintf("RAPID.Q%d", i)}},
							},
						},
					},
				}
			...
			app := brokerv1beta1.BrokerApp{
				...
				Spec: brokerv1beta1.BrokerAppSpec{
					...
					Capabilities: []brokerv1beta1.AppCapabilityType{
						{
							Role:       "workQueue",
							ProducerOf: []brokerv1beta1.AppAddressType{{Address: "SPECIAL.QUEUE"}},
						},
					},
				},
			}
			...
			app := brokerv1beta1.BrokerApp{
				...
				Spec: brokerv1beta1.BrokerAppSpec{
					...
					Capabilities: []brokerv1beta1.AppCapabilityType{
						{
							Role:       "workQueue",
							ProducerOf: []brokerv1beta1.AppAddressType{{Address: "ORPHAN.QUEUE"}},
						},
					},
				},
			}
