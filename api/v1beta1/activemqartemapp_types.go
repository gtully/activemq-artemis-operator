...
//+kubebuilder:resource:path=activemqartemisapp,shortName=aaapp
//+operator-sdk:csv:customresourcedefinitions:resources={{"Secret", "v1"}}

// Provides a broker application
// +operator-sdk:csv:customresourcedefinitions:displayName="ActiveMQ Artemis Messaging Application"
